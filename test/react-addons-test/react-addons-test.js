...
// Used to store breadth-first search state in findComponentRoot.
	...
	var ReactMount = {
		...
		prepareEnvironmentForDOM: function(container) {
			console.log("prepareEnvironmentForDOM", container, ELEMENT_NODE_TYPE, DOC_NODE_TYPE);
			console.log(container && container.nodeType, ELEMENT_NODE_TYPE, DOC_NODE_TYPE);
		...
		_registerComponent: function(nextComponent, container) {
			console.log(nextComponent, container);
	...
	if ("production" !== "development") {
		var invariantDev = function(condition, format, a, b, c, d, e, f) {
			...
			if (!condition) {
				...
				var argIndex = 0;
				console.log(condition, format, a, b, c, d, e, f)
				throw new Error(
					'Invariant Violation: ' +
